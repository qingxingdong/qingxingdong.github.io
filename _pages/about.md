...
- 有一定的数学与计算机基础（计算传播方向）**或**实证研究基础（信息传播行为方向）
- 具有一定的英语阅读和写作能力
...
来信请注意：
- 不要使用模板套磁信。如果有兴趣，可以参考前面的要求，写清楚自己的未来计划（学习目标、职业规划等），以及为什么要来我们团队学习
- 邮件附件请包含个人基本资料：CV、成绩单、代表性论文等
- 首次来信一般必回。如两周以上未收到回信，可以再发邮件确认一遍，避免是邮件系统的问题
